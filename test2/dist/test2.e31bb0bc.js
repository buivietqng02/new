...
(0, _dateFns.format)(new Date(), "'today is a ' eeee");
console.log((0, _dateFns.formatDistance)((0, _dateFns.subDays)(new Date(), 3), new Date(), {
  addSuffix: true
}));
(0, _dateFns.formatRelative)((0, _dateFns.subDays)(new Date(), 3), new Date());
var x = 1;

var inner1 = function inner1() {
  return function (o) {
    console.log(o);
  };
};
...
//# sourceMappingURL=/test2.e31bb0bc.js.map